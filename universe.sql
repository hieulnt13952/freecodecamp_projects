...
INSERT INTO public.moon VALUES (20, 's', 1, 20, 1, true, true, 't', 1);
...
--
-- Name: comet comet_distance_unique; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.comet
    ADD CONSTRAINT comet_distance_unique UNIQUE (distance_from_earth);
...
--
-- Name: galaxy galaxy_distance_unique; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.galaxy
    ADD CONSTRAINT galaxy_distance_unique UNIQUE (distance_from_earth);
...
ALTER TABLE ONLY public.moon
    ADD CONSTRAINT moon_distance_unique UNIQUE (distance_from_earth);
...
ALTER TABLE ONLY public.star
    ADD CONSTRAINT star_distance_unique UNIQUE (distance_from_earth);
